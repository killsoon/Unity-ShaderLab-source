Shader "Tut/SurfaceShader/Forward/Lab_1/noForwardAddNoLM_Surf" {
	Properties {
	...
	SubShader {
		...
		LOD 200
		CGPROGRAM
		#pragma surface surf LitModel exclude_path:prepass 	 vertex:vert finalcolor:mycolor	noforwardadd nolightmap
		#pragma debug	  
