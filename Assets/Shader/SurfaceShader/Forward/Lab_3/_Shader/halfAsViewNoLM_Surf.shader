Shader "Tut/SurfaceShader/Forward/Lab_3/halfAsViewNoLM_Surf" {
	Properties {
	...
	SubShader {
		...
		LOD 200
		CGPROGRAM
		#pragma surface surf LitModel exclude_path:prepass 	 vertex:vert finalcolor:mycolor	nolightmap halfasview
		#pragma debug
		#pragma target 3.0
