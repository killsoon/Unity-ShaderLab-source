Shader "Tut/SurfaceShader/Forward/Lab_3/noAmbientNoLM_Surf" {
	Properties {
	...
	SubShader {
		...
		LOD 200
		CGPROGRAM
		#pragma surface surf LitModel exclude_path:prepass 	 vertex:vert finalcolor:mycolor	 noambient nolightmap
		#pragma debug	  
