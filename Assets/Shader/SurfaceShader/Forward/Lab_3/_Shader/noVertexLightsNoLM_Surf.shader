Shader "Tut/SurfaceShader/Forward/Lab_1/noVertexLightsNoLM_Surf" {
	Properties {
	...
	SubShader {
		...
		LOD 200
		CGPROGRAM
		#pragma surface surf LitModel exclude_path:prepass 	 vertex:vert finalcolor:mycolor	 novertexlights nolightmap
		#pragma debug	  
		sampler2D _MainTex;
		sampler2D _BumpMap;
		fixed4 _ColorTint;
