Shader "Tut/SurfaceShader/Forward/Lab_4/alphaNoLM_Surf" {
	Properties {
	...
	SubShader {
		...
		LOD 200
		CGPROGRAM
		#pragma surface surf LitModel exclude_path:prepass 	 vertex:vert finalcolor:mycolor	alpha nolightmap
		#pragma debug	  
