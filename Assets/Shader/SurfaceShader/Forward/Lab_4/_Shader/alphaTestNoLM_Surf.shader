Shader "Tut/SurfaceShader/Forward/Lab_4/alphaTestNoLM_Surf" {
	Properties {
	...
	SubShader {
		...
		LOD 200
		CGPROGRAM
		#pragma surface surf LitModel exclude_path:prepass 	 vertex:vert finalcolor:mycolor	alphatest:_CutOff nolightmap
		#pragma debug	  
