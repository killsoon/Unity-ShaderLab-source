Shader "Tut/SurfaceShader/Forward/Lab_4/decalAddNoLM_Surf" {
	Properties {
	...
	SubShader {
		...
		LOD 200
		CGPROGRAM
		#pragma surface surf LitModel exclude_path:prepass 	 vertex:vert finalcolor:mycolor	nolightmap decal:add
		#pragma debug
