Shader "Tut/SurfaceShader/Forward/Lab_6/dualForward_Surf" {
	Properties {
	...
	SubShader {
		...
		LOD 200
		CGPROGRAM
		#pragma surface surf LitModel exclude_path:prepass 	 vertex:vert finalcolor:mycolor	 dualforward
		...
		void surf (Input IN, inout SurfaceOutput o) {
			...
			o = (SurfaceOutput)0;// No SurfaceOutput at the beginning of the line, because it should already be defined before the surface function is called.
			//#endif
			#else
			o.Emission=0.0;
			#endif
