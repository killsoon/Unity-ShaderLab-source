Shader "Tut/SurfaceShader/Forward/Lab_6/addShadowNoLM_Surf" {
	Properties {
	...
	SubShader {
		...
		LOD 200
		CGPROGRAM
		#pragma surface surf LitModel exclude_path:prepass 	 vertex:vert finalcolor:mycolor	addshadow nolightmap
